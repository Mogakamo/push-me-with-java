...
public class Main extends Application {
    ...
    public void start(Stage stage) throws Exception{
        ...
        //create and configure a label which will cause the text to be displated
        Button pushMeButton = new Button();
        pushMeButton.setText("Type something in the box and then push me");
        ...
        //add the scene to the stage and then configure the stage and make it visible
